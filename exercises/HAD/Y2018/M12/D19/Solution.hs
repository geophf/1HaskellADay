module Y2018.M12.D19.Solution where
...
correctNumberFormat inFile outFile = readFile inFile >>=
   writeFile outFile . unlines . map enplusify . words

enplusify :: String -> String
enplusify n = case n of
   ('-':_)   -> n
   otherwise -> '+':n

{--
>>> correctNumberFormat (exDir ++ nums) (exDir ++ "plusses.txt")
