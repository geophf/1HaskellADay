...
insertCats = insertion catStmt

insertion :: Query -> Connection -> LookupTable -> IO ()
insertion catStmt conn =
   void . executeMany conn catStmt . map (uncurry IxV . swap . first Cat)
        . Map.toList

{--
>>> withConnection WPJ (flip insertCats (cats2lk json))
...
----------------
7574	African Angle
7575	Arctic in Context
7576	Arts-Policy
7577	Big Question
7578	Citizenship & Identity
7579	Coda Story
7580	Cuban Reset
7604	Culture
7603	Economy
7581	Elections & Institutions
--}
