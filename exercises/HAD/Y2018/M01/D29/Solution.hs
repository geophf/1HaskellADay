...
module Y2018.M01.D29.Solution where
...
fetchLastUpdated conn = map day <$> query_ conn fetchLastUpdateStmt

{--
>>> fetchLastUpdated conn
[2018-01-13]
--}
...
day :: Date -> Day
day (Date (Finite ts)) = localDay ts
