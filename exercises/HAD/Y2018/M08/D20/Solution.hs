module Y2018.M08.D20.Solution where
...
distill2UUID = fst . break (== '.') . tail . snd . break (== '_')
...
{--
>>> distill2UUID (head urls)
"f88063e4-94d3-11e8-81a7-7310897d834f"
>>> length urls
57

>>> mapM_ ((\uuid -> putStrLn ('\'':uuid ++ "',")) . distill2UUID) urls
'f88063e4-94d3-11e8-81a7-7310897d834f',
'8c086332-91b9-11e8-b080-8f148df7547f',
'63ed2b00-9121-11e8-9662-7bbab5e2677e',
'36228392-8c3e-11e8-9599-33072b1efcc4',
'2a53189d-3c1e-5cd5-ab9d-bbc98547764d',
'c9e32f9e-9591-11e8-bccf-1bfba760ed65',
...
--}
