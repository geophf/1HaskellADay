...
module Y2020.M12.D21.Exercise where
...
import Y2020.M10.D12.Solution hiding (Country)  -- for AirBase, ... not Country
...
ncfoab2AirBase (Country c _ _) ncfoab = undefined
...
airbasesOf url country = undefined
...
airbasesFor url alliance = undefined
...
countryAirBaseRow row = undefined

-- ... so does that mean:

instance FromJSON CountryAirBaseRel where
   parseJSON = withArray "Country-Air Base row" undefined
