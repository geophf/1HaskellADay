module Y2016.M11.D16.Solution where
...
stable = (== 0) . sum . map (uncurry (*) . first oxidationState)

-- Of course, listing the atoms of a compound is one thing. We'll be looking
-- at chemical bonds in another exercise.

{--
*Y2016.M11.D16.Solution> stable water ~> True
*Y2016.M11.D16.Solution> stable theobromine ~> False

Hm. I can't get theobromine to balance. Is it because it's an alkaloid? Or
because oxidation numbers are more complex than just an integer can represent?
--}
