module Y2017.M04.D18.Solution where
...
import Y2017.M04.D17.Solution (stateCapitalsQuery, StateCapital)
...
I am migrating the above building components to Wikidata.Query.Builder
--}
